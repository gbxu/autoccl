...
// Initialize a socket
__attribute__((visibility("default"))) ncclResult_t ncclSocketInit(struct ncclSocket* sock, union ncclSocketAddress* addr = NULL, uint64_t magic = NCCL_SOCKET_MAGIC, enum ncclSocketType type = ncclSocketTypeUnknown, volatile uint32_t* abortFlag = NULL, int asyncFlag = 0);
// Create a listening socket. sock->addr can be pre-filled with IP & port info. sock->fd is set after a successful call
ncclResult_t ncclSocketListen(struct ncclSocket* sock);
ncclResult_t ncclSocketGetAddr(struct ncclSocket* sock, union ncclSocketAddress* addr);
// Connect to sock->addr. sock->fd is set after a successful call.
__attribute__((visibility("default"))) ncclResult_t ncclSocketConnect(struct ncclSocket* sock);
...
__attribute__((visibility("default"))) ncclResult_t ncclSocketAccept(struct ncclSocket* sock, struct ncclSocket* ulistenSock);
...
__attribute__((visibility("default"))) ncclResult_t ncclSocketSend(struct ncclSocket* sock, void* ptr, int size);
__attribute__((visibility("default"))) ncclResult_t ncclSocketRecv(struct ncclSocket* sock, void* ptr, int size);
__attribute__((visibility("default"))) ncclResult_t ncclSocketTryRecv(struct ncclSocket* sock, void* ptr, int size, int* closed, bool blocking);
__attribute__((visibility("default"))) ncclResult_t ncclSocketClose(struct ncclSocket* sock);
#endif
