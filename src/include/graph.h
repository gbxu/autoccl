...
ncclResult_t ncclTopoCheckP2p(struct ncclTopoSystem* system, int64_t id1, int64_t id2, int* p2p, int *read, int* intermediateRank, bool native, int32_t tuner_p2pLevel = -1, int* currP2pLevel = NULL);
