...
__attribute__((visibility("default"))) ncclResult_t ncclLoadTunerPlugin(ncclTuner_t** tuner) {
...
__attribute__((visibility("default"))) ncclResult_t ncclCloseTunerPlugin(ncclTuner_t** tuner) {
